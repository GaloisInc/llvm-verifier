...
@.str = private unnamed_addr constant [15 x i8] c"test-fresh.aig\00"
...
define i32 @main() nounwind ssp {
  ...
  call void @write_aiger_uint32(i32 %6, i8* getelementptr inbounds ([15 x i8]* @.str, i32 0, i32 0))
  %7 = load i32* %y, align 4
  %8 = getelementptr inbounds [32 x i8]* %inputs, i32 0, i32 0
  %9 = call i32 @eval_aiger_uint32(i32 %7, i8* %8, i32 32)
  ret i32 %9
}
...
declare i32 @eval_aiger_uint32(i32, i8*, i32)
