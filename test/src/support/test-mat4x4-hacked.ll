; Same as test-mat4x4.ll, except with explicit labels until the
; parser/CFG construction supports dealing with anonymous labels.  No,
; fresh names for labels is not a viable solution =)
...
zero:
  add i32 0, 0 ; implicit enumeration padding hack
...
three:
  ...
  %5 = icmp slt i32 %4, 4
  br i1 %5, label %six, label %fiftyfive
...
seven:
  ...
  %9 = icmp slt i32 %8, 4
  br i1 %9, label %ten, label %fiftyone
...
seventeen: 
  ...
  br i1 %19, label %twenty, label %fortyseven
